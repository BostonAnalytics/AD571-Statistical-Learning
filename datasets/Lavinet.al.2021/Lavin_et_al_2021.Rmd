---
title: "Minimum size limits and the reproductive value of numerous, young, mature female fish"
...
# number of NYMFFs assigned to offspring
...
## number of NYMFF vs number of above-MSL from UVC
```{r}
...
#B. FIT DISTRIBUTIONS
##Testing to determine distribution of assigned, sampled and surveyed data, Gamma, Weibull, lnorm, normal 
```{r}
